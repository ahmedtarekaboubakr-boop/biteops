...
import { authenticateToken, requireManager, requireManagerOrStaff } from '../middleware.js';
...
router.get('/', authenticateToken, requireManagerOrStaff, scheduleController.getSchedules);
