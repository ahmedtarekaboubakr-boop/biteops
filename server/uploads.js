...
// Memory storage — file stays in req.file.buffer, goes straight to MongoDB as base64
export const memoryUploadPhoto = multer({
  storage: multer.memoryStorage(),
  limits: { fileSize: 5 * 1024 * 1024 },
  fileFilter: (req, file, cb) => {
    const ok = /jpeg|jpg|png|gif|webp/.test(file.originalname.toLowerCase().split('.').pop()) ||
